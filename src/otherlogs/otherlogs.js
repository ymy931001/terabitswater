...
import { Icon, Menu, Layout, Button, Tabs, Input, LocaleProvider, Table, Modal, DatePicker } from 'antd';
          ...
          <Layout>
            ...
            >
              ...
              <div className="Layout-left">
                ...
                >
                  <Menu.Item key="21" style={{ background: '#0099CB', color: 'white', fontSize: "18px", display: "block", width: "94%", borderRadius: '5px', marginLeft: "3%", marginRight: '3%' }}>
                    <Icon type="windows" />
                    <span>水表管理平台</span>
                  </Menu.Item>
                  <Menu.Item>
