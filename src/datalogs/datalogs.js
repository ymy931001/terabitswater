          ...
          <Layout>
            ...
            >
              ...
              <div className="Layout-left">
                ...
                >
                  <Menu.Item key="18" style={{ background: ' #0099CB', color: 'white', fontSize: "18px", display: "block", width: "94%", borderRadius: '5px', marginLeft: "3%", marginRight: '3%' }}>
                    <Icon type="windows" />
                    <span>水表管理平台</span>
                  </Menu.Item>
                  <Menu.Item>
            ...
            <Layout>
              ...
              <Content style={{ margin: '24px 16px', padding: 24, background: '#fff', minHeight: 280 }}>
                ...
                />
                设备编号：<Input placeholder="请输入设备编号：" style={{ width: '20%', marginLeft: '10px' }} id="username" />
